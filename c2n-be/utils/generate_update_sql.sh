...
VALUES
    ($id,'pcontract_$id','pcontract_$id desc','/img/pc_$id.jpg','david_$id',0,'10000000000000000000000',
     ...
     NOW(),NOW(),0,'http://card_link_$id.com','tweet_id_$id',$chainId,18,0);"
